...
#ifndef COSMIC_NOMAD_ECHOES_SWIFT_H
#define COSMIC_NOMAD_ECHOES_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="COSMIC_NOMAD_ECHOES",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class MTKView;
SWIFT_CLASS("_TtC19COSMIC_NOMAD_ECHOES10GameEngine")
@interface GameEngine : NSObject <MTKViewDelegate>
...
@class UITouch;
@class UIEvent;
SWIFT_CLASS("_TtC19COSMIC_NOMAD_ECHOES11GameMTKView")
@interface GameMTKView : MTKView
...
SWIFT_CLASS("_TtC19COSMIC_NOMAD_ECHOES13MetalRenderer")
